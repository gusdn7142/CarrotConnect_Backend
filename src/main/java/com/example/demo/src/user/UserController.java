...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    @ResponseBody
    @PostMapping("/{idx}/hiddens")
    public BaseResponse<String> hideUser(@PathVariable("idx") int userIdx, @RequestBody PostHideUserReq postHideUserReq){   //BaseResponse<String>
        ...
        try {
            ...
            userService.hideUser(postHideUserReq);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    @ResponseBody
    @PatchMapping("/{idx}/hiddens/status")
    public BaseResponse<String> hideUserCancell(@PathVariable("idx") int userIdx, @RequestBody PatchHideUserCancellReq patchHideUserCancellReq){   //BaseResponse<String>
        ...
        try {
            ...
            userService.hideUserCancell(patchHideUserCancellReq);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    @ResponseBody
    @PostMapping("/{idx}/user-reports")
    public BaseResponse<String> reportUser(@PathVariable("idx") int userIdx, @RequestBody PostUserReportReq postUserReportReq){   //BaseResponse<String>
        ...
        try {
            ...
            PostHideUserReq postHideUserReq = new PostHideUserReq(userIdx, postUserReportReq.getReportNickName() );
            String hideResult = "";

            if(postUserReportReq.getHiddenStatus() == 1) {   //hiddenStatus값 (미노출 사용자 추가 여부값) 에 1이 들어와 있으면
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    @ResponseBody
    @PostMapping("/{idx}/product-reports")
    public BaseResponse<String> reportProduct(@PathVariable("idx") int userIdx, @RequestBody PostProductReportReq PostProductReportReq){   //BaseResponse<String>
        ...
        try {
            ...
            //상품 게시글 신고
            PostProductReportReq.setUserIdx(userIdx);
            userService.reportProduct(PostProductReportReq);


            //미노출 사용자 처리 (+미노출 처리 여부 확인 포함)
            PostHideUserReq postHideUserReq = new PostHideUserReq(userIdx, PostProductReportReq.getReportNickName() );
            String hideResult = "";

            if(PostProductReportReq.getHiddenStatus() == 1) {   //hiddenStatus값 (미노출 사용자 추가 여부값)에 1이 들어와 있으면
                userService.hideUser(postHideUserReq);       //미노출 사용자 추가 수행
                hideResult = " 숨김 처리도 완료하였습니다.";
            }
